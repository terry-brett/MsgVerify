...
DATA_PATH = "../datasets/phishing_messages_datasets/annotated with reasoning labels/Dataset_10191_tuned_eval_ready.csv"
...
if "LABEL" in df.columns:
    spam = df[df["LABEL"].isin(["spam", "smishing"])].copy()
    evaluate(spam, title="MALICIOUS only (spam + smishing)")
